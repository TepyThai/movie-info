...
public class MovieVideo implements Parcelable
{
    ...
    public final static Parcelable.Creator<MovieVideo> CREATOR = new Creator<MovieVideo>() {
        ...
        public MovieVideo createFromParcel(Parcel in) {
            MovieVideo instance = new MovieVideo();
     ...
     * @param size
     */
    public MovieVideo(String id, String iso6391, String iso31661, String key, String name, String site, Integer size, String type) {
        super();
        this.id = id;
